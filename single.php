            ...
            <div class="content-area col-md-12" id="primary"> 
                <main class="site-main" id="main"> 
                    <div> 
                        ...
                        <?php endif; ?> 
                        <div class="container">
                            <?php if ( ($tags) {   $tag_ids = array();   foreach($tags as $individual_tag) $tag_ids[] = $individual_tag->term_id;   $args=array(   'tag__in' => $tag_ids,   'post__not_in' => array($post->ID),   'posts_per_page'=>4, // Number of related posts to display.   'caller_get_posts'=>1   ); ) : ?>
                                <?php if ( $tags->have_posts() ) : ?>
                                    <div <?php post_class( 'row' ); ?> id="post-<?php the_ID(); ?>">
                                        <div class="col-md-4">
                                            <?php $tags_item_number = 0; ?>
                                            <?php while ( $tags->have_posts() && $tags_item_number++ < 3 ) : $tags->the_post(); ?>
