                        ...
                        <figure style="grid-area:2 / 2 / 5 / 6;" <?php post_class( 'imghvr-blur' ); ?> id="post-<?php the_ID(); ?>">
                            ...
                            <a href="<?php echo get_post_meta( get_the_ID(), 'Link', true ); ?>">
                                <figcaption>
                                    ...
                                    <a class="btn active btn-sm btn-danger hvr-sweep-to-left bs-tooltip-bottom" role="button" aria-pressed="true" data-html="false" data-toggle="tooltip" href="<?php echo get_post_meta( get_the_ID(), 'T&C´s link', true ); ?>" title="<?php echo get_post_meta( get_the_ID(), 'Key', true ); ?>" data-placement="bottom" data-trigger="hover"><?php _e( 'T&C´s', 'st2' ); ?></a>
                                    <h6 class="text-center display-5 "><?php the_title(); ?></h6>
                                    <?php the_excerpt( ); ?>
                                </figcaption>
                            </a>
